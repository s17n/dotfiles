...
#export PATH="$(brew --prefix python)/libexec/bin:/usr/local/opt/ruby/bin:$HOME/bin:/usr/local/bin:$PATH"
export PATH="/usr/local/opt/ruby/bin:$HOME/bin:/usr/local/bin:$PATH"
...
plugins=(git nvm fzf colored-man-pages macOS)
